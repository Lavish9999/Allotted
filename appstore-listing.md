...
Allotted
```
Alt for more search visibility:
```
Allotted Budget Planner
```
...
```
budget,budgeting,money,finance,zero based,envelope,expense,spending,tracker,savings,bills,debt
```
...
Use the hosted support page once GitHub Pages or your preferred host is enabled. Recommended path:
```
https://lavish9999.github.io/Allotted/support.html
```
Fallback if Pages is not enabled yet:
```
https://github.com/Lavish9999/Allotted
```

## Privacy Policy URL  *(required)*
Use the hosted privacy page once GitHub Pages or your preferred host is enabled. Recommended path:
```
...
This is accurate because Allotted stores everything in local on-device storage, has no analytics, no network calls, and no third-party SDKs. This single answer produces the "Data Not Collected" label.
